...
public class PlacementAdGroupCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "AdGroup_ID,AdGroup_Name,Placement,Impression_Device,Reach, " +
    ...
    public static String writecsvfile(List<CSVPlacementAdGroupStats> overAllAdGroupStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(PlacementAdGroupCSVWriter.class);
        //boolean stored=false;

        String File_Starting_Name="DPAStats";

        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Placement_Ad_Group_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVPlacementAdGroupStats csvOverAllAccountStats:overAllAdGroupStatsList){
