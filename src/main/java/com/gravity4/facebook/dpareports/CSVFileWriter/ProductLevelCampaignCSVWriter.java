...
public class ProductLevelCampaignCSVWriter {
    ...
    public static String writecsvfile(List<CSVProductLevelCampaignStats> productLevelCampaignStatsList,long page_id, java.sql.Date Stats_date) throws IOException {
        ...
        //create File object
        File file = new File("src/main/ReportFiles/csv_Files/"+File_Starting_Name+"_"+"ProductLevelCampaignStats_"+Stats_date+".csv");
