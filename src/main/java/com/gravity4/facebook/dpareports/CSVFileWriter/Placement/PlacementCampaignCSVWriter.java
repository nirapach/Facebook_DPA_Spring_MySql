package com.gravity4.facebook.dpareports.CSVFileWriter.Placement;
...
public class PlacementCampaignCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Campaign_ID,Campaign_Name,Placement,Impression_Device,Reach, " +
    ...
    public static String writecsvfile(List<CSVPlacementCampaignStats> overAllCampaignStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(PlacementCampaignCSVWriter.class);
        //boolean stored=false;

        String File_Starting_Name="DPAStats";

        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Placement_Campaign_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVPlacementCampaignStats csvOverAllAccountStats:overAllCampaignStatsList){
                ...
                fileWriter.append(COMMA_DELIMITER);
                fileWriter.append(csvOverAllAccountStats.getPlacement());
                fileWriter.append(COMMA_DELIMITER);
                fileWriter.append(csvOverAllAccountStats.getImpression_Device());
                fileWriter.append(COMMA_DELIMITER);
