package com.gravity4.facebook.dpareports.CSVFileWriter.Country;
...
public class CountryCampaignCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Campaign_ID,Campaign_Name,CountryandRegion,Reach, " +
    ...
    public static String writecsvfile(List<CSVCountryCampaignStats> overAllCampaignStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(CountryCampaignCSVWriter.class);
        //boolean stored=false;

        String File_Starting_Name="DPAStats";

        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Country_Campaign_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVCountryCampaignStats csvOverAllAccountStats:overAllCampaignStatsList){
                ...
                fileWriter.append(COMMA_DELIMITER);
                fileWriter.append(csvOverAllAccountStats.getCountry());
                fileWriter.append(COMMA_DELIMITER);
