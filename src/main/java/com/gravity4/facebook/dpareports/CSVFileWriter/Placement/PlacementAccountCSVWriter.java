...
public class PlacementAccountCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Account_ID,Account_Name,Placement,Impression_Device,Reach, " +
    ...
    public static String writecsvfile(List<CSVPlacementAccountStats> overAllAccountStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(PlacementAccountCSVWriter.class);

        String File_Starting_Name="DPAStats";
        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Placement_Account_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVPlacementAccountStats csvOverAllAccountStats:overAllAccountStatsList){
