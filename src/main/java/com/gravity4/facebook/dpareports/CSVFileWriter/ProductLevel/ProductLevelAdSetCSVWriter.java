...
public class ProductLevelAdSetCSVWriter {
    ...
    public static String writecsvfile(List<CSVProductLevelAdSetStats> productLevelAdSetStatsList,long page_id, java.sql.Date Stats_date,String csv_address) throws IOException {
        ...
        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Product_Level_Ad_Set_Stats_"+Stats_date+".csv");
