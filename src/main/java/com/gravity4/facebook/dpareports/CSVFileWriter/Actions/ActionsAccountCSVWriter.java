...
public class ActionsAccountCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Account_ID,Account_Name,Action_Types, " +
            "Values,Activity_Start_Date,Activity_End_Date";

    public static String writecsvfile(List<CSVActionsAccountStats> overAllAdGroupStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(ActionsAccountCSVWriter.class);
        //boolean stored=false;

        String File_Starting_Name="DPAStats";

        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Action_Types_Account_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVActionsAccountStats csvOverAllAccountStats:overAllAdGroupStatsList){
