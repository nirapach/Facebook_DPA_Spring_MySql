package com.gravity4.facebook.dpareports.CSVFileWriter.ProductLevel;
...
public class ProductLevelCampaignCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Campaign_ID,Campaign_Name,Product_id,Product_Desc,Reach, " +
    ...
    public static String writecsvfile(List<CSVProductLevelCampaignStats> productLevelCampaignStatsList,long page_id, java.sql.Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(ProductLevelCampaignCSVWriter.class);
        ...
        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Product_Level_Campaign_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVProductLevelCampaignStats csvOverAllAccountStats:productLevelCampaignStatsList){
