...
public class AggregatedAdSetCSVWriter {
    ...
    public static String writecsvfile(List<CSVAggregatedAdSetStats> overAllAdSetStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(AggregatedAdSetCSVWriter.class);

        String File_Starting_Name="DPAStats";


        //create File object
        File file = new File(csv_address+ File_Starting_Name+"_"+"Aggregated_Ad_Set_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVAggregatedAdSetStats csvOverAllAccountStats:overAllAdSetStatsList){
