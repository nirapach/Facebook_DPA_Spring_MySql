...
public class AggregatedAccountCSVWriter {
    ...
    public static String writecsvfile(List<CSVAggregatedAccountStats> overAllAccountStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(AggregatedAccountCSVWriter.class);

        String File_Starting_Name="DPAStats";
        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Aggregated_Account_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVAggregatedAccountStats csvOverAllAccountStats:overAllAccountStatsList){
