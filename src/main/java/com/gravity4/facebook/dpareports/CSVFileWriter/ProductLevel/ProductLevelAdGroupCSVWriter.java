...
public class ProductLevelAdGroupCSVWriter {
    ...
    public static String writecsvfile(List<CSVProductLevelAdGroupStats> productLevelAdGroupStatsList,long page_id, java.sql.Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(ProductLevelAdGroupCSVWriter.class);
        ...
        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Product_Level_Ad_Group_Stats_"+Stats_date+".csv");
