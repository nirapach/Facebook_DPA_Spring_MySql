package com.gravity4.facebook.dpareports.CSVFileWriter.Aggregated;
...
public class AggregatedCampaignCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Campaign_ID,Campaign_Name,Reach, " +
    ...
    public static String writecsvfile(List<CSVAggregatedCampaignStats> overAllCampaignStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(AggregatedCampaignCSVWriter.class);
        //boolean stored=false;

        String File_Starting_Name="DPAStats";

        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Aggregated_Campaign_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVAggregatedCampaignStats csvOverAllAccountStats:overAllCampaignStatsList){
