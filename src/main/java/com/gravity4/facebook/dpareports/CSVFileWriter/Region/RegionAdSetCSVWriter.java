...
public class RegionAdSetCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "AdSet_ID,AdSet_Name,Region,Reach, " +
    ...
    public static String writecsvfile(List<CSVRegionAllAdSetStats> overAllAdSetStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(RegionAdSetCSVWriter.class);

        String File_Starting_Name="DPAStats";


        //create File object
        File file = new File(csv_address+ File_Starting_Name+"_"+"Region_Ad_Set_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVRegionAllAdSetStats csvOverAllAccountStats:overAllAdSetStatsList){
