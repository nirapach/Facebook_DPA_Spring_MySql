...
public class RegionAccountCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "Account_ID,Account_Name,Region,Reach, " +
    ...
    public static String writecsvfile(List<CSVRegionAllAccountStats> overAllAccountStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(RegionAccountCSVWriter.class);

        String File_Starting_Name="DPAStats";
        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Region_Account_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVRegionAllAccountStats csvOverAllAccountStats:overAllAccountStatsList){
