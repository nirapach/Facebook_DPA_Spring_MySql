...
public class ActionsAdGroupCSVWriter {
    ...
    private static final String FILE_HEADER = "Stats_Date,Page_ID," +
            "AdGroup_ID,AdGroup_Name,Action_Types, " +
            "Values,Activity_Start_Date,Activity_End_Date";

    public static String writecsvfile(List<CSVActionsAdGroupStats> overAllAdGroupStatsList,long page_id, Date Stats_date,String csv_address) throws IOException {

        Logger logger = LoggerFactory.getLogger(ActionsAdGroupCSVWriter.class);
        //boolean stored=false;

        String File_Starting_Name="DPAStats";

        //create File object
        File file = new File(csv_address+File_Starting_Name+"_"+"Action_Types_Ad_Group_Level_Stats_"+Stats_date+".csv");
     ...
     * it was created successfully, false otherwise.
        */
        ...
        try {
            ...
            for(CSVActionsAdGroupStats csvOverAllAccountStats:overAllAdGroupStatsList){
