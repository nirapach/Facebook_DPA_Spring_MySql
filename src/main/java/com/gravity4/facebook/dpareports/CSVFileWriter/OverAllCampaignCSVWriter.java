...
public class OverAllCampaignCSVWriter {
    ...
    public static String writecsvfile(List<CSVOverAllCampaignStats> overAllCampaignStatsList,long page_id, java.sql.Date Stats_date) throws IOException {

        Logger logger = LoggerFactory.getLogger(OverAllCampaignCSVWriter.class);
        //boolean stored=false;

        //create File object
        File file = new File("src/main/ReportFiles/"+page_id+"_"+"OverAllCampaignLevelStats_"+Stats_date+".csv");
