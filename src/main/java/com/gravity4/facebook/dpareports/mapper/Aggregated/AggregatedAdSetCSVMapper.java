...
public class AggregatedAdSetCSVMapper implements RowMapper<CSVAggregatedAdSetStats> {


    @Override
    public CSVAggregatedAdSetStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVAggregatedAdSetStats csvOverAllAdSetStats=new CSVAggregatedAdSetStats();
