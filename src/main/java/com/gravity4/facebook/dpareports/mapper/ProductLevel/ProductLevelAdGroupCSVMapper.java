...
public class ProductLevelAdGroupCSVMapper implements RowMapper<CSVProductLevelAdGroupStats> {
    ...
    public CSVProductLevelAdGroupStats mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        csvProductLevelAdGroupStats.setActivity_End_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_End"));
        csvProductLevelAdGroupStats.setActivity_Start_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_Start"));
