...
public class CountryAdGroupCSVMapper implements RowMapper<CSVCountryAdGroupStats> {


    @Override
    public CSVCountryAdGroupStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVCountryAdGroupStats csvOverAllAdGroupStats=new CSVCountryAdGroupStats();
        ...
        csvOverAllAdGroupStats.setCountry(resultSet.getString("Country"));
