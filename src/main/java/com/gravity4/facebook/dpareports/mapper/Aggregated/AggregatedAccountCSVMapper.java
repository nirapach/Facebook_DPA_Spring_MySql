...
public class AggregatedAccountCSVMapper implements RowMapper<CSVAggregatedAccountStats> {


    @Override
    public CSVAggregatedAccountStats mapRow(ResultSet resultSet, int i) throws SQLException {

        CSVAggregatedAccountStats csvOverAllAccountStats=new CSVAggregatedAccountStats();
