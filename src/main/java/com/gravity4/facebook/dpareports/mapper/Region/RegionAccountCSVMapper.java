...
public class RegionAccountCSVMapper implements RowMapper<CSVRegionAllAccountStats> {


    @Override
    public CSVRegionAllAccountStats mapRow(ResultSet resultSet, int i) throws SQLException {

        CSVRegionAllAccountStats csvOverAllAccountStats=new CSVRegionAllAccountStats();
        ...
        csvOverAllAccountStats.setRegion(resultSet.getString("Region"));
