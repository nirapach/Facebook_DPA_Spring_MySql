...
public class ProductLevelAdSetCSVMapper implements RowMapper<CSVProductLevelAdSetStats> {
    ...
    public CSVProductLevelAdSetStats mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        csvProductLevelAdSetStats.setActivity_End_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_End"));
        csvProductLevelAdSetStats.setActivity_Start_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_Start"));
