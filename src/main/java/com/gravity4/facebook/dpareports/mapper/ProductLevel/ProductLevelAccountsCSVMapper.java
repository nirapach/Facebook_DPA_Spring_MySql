...
public class ProductLevelAccountsCSVMapper implements RowMapper<CSVProductLevelAccountStats> {
    ...
    public CSVProductLevelAccountStats mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        csvProductLevelStats.setActivity_End_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_End"));
        csvProductLevelStats.setActivity_Start_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_Start"));
