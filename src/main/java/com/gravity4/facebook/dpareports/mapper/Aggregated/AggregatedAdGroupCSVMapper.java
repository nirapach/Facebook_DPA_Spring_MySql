...
public class AggregatedAdGroupCSVMapper implements RowMapper<CSVAggregatedAdGroupStats> {


    @Override
    public CSVAggregatedAdGroupStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVAggregatedAdGroupStats csvOverAllAdGroupStats=new CSVAggregatedAdGroupStats();
