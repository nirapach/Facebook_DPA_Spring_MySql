package com.gravity4.facebook.dpareports.mapper.Aggregated;
...
public class AggregatedCampaignCSVMapper implements RowMapper<CSVAggregatedCampaignStats> {


    @Override
    public CSVAggregatedCampaignStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVAggregatedCampaignStats csvOverAllCampaignStats=new CSVAggregatedCampaignStats();
