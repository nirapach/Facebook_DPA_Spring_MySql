...
public class OverAllCampaignCSVMapper implements RowMapper<CSVOverAllCampaignStats> {
    ...
    public CSVOverAllCampaignStats mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        csvOverAllCampaignStats.setActivity_End_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_Start"));
        csvOverAllCampaignStats.setActivity_Start_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_End"));
