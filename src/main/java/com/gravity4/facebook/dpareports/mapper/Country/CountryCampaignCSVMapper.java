...
public class CountryCampaignCSVMapper implements RowMapper<CSVCountryCampaignStats> {


    @Override
    public CSVCountryCampaignStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVCountryCampaignStats csvOverAllCampaignStats=new CSVCountryCampaignStats();
        ...
        csvOverAllCampaignStats.setCountry(resultSet.getString("Country"));
