...
public class PlacementAdGroupCSVMapper implements RowMapper<CSVPlacementAdGroupStats> {


    @Override
    public CSVPlacementAdGroupStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVPlacementAdGroupStats csvOverAllAdGroupStats=new CSVPlacementAdGroupStats();
        ...
        csvOverAllAdGroupStats.setPlacement(resultSet.getString("Client_Reports_Placement"));
        csvOverAllAdGroupStats.setClicks(resultSet.getInt("Client_Reports_Clicks"));
        csvOverAllAdGroupStats.setImpression_Device(resultSet.getString("Client_Reports_Impression_Device"));
