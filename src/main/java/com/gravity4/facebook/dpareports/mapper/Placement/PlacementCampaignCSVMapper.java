...
public class PlacementCampaignCSVMapper implements RowMapper<CSVPlacementCampaignStats> {


    @Override
    public CSVPlacementCampaignStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVPlacementCampaignStats csvOverAllCampaignStats=new CSVPlacementCampaignStats();
        ...
        csvOverAllCampaignStats.setPlacement(resultSet.getString("Client_Reports_Placement"));
        csvOverAllCampaignStats.setClicks(resultSet.getInt("Client_Reports_Clicks"));
        csvOverAllCampaignStats.setImpression_Device(resultSet.getString("Client_Reports_Impression_Device"));
