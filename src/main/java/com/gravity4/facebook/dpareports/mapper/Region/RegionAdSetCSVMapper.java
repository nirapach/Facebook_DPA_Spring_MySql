...
public class RegionAdSetCSVMapper implements RowMapper<CSVRegionAllAdSetStats> {


    @Override
    public CSVRegionAllAdSetStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVRegionAllAdSetStats csvOverAllAdSetStats=new CSVRegionAllAdSetStats();
        ...
        csvOverAllAdSetStats.setRegion(resultSet.getString("Region"));
