package com.gravity4.facebook.dpareports.mapper.ProductLevel;
...
public class ProductLevelCampaignCSVMapper implements RowMapper<CSVProductLevelCampaignStats> {
    ...
    public CSVProductLevelCampaignStats mapRow(ResultSet resultSet, int i) throws SQLException {
        ...
        csvProductLevelCampaignStats.setActivity_End_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_End"));
        csvProductLevelCampaignStats.setActivity_Start_Date(resultSet.getDate("Client_Reports_Ad_Activity_Date_Start"));
