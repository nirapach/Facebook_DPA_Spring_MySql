...
public class ActionsAccountCSVMapper implements RowMapper<CSVActionsAccountStats> {


    @Override
    public CSVActionsAccountStats mapRow(ResultSet resultSet, int i) throws SQLException {


        CSVActionsAccountStats csvOverAllAdGroupStats=new CSVActionsAccountStats();


        csvOverAllAdGroupStats.setPage_ID(resultSet.getLong("Application_Client_ID"));
        csvOverAllAdGroupStats.setAccount_ID(resultSet.getLong("Application_AdAccount_ID"));
        csvOverAllAdGroupStats.setAccount_Name(resultSet.getString("Application_AdAccount_Name"));
