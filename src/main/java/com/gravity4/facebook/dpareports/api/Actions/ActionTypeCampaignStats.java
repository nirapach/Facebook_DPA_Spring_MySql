...
import com.gravity4.facebook.dpareports.CSVFileWriter.Actions.ActionsCampaignCSVWriter;
import com.gravity4.facebook.dpareports.dao.Actions.ActionTypeCampaignLevelStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.actions.CampaignActionTypesStatsJSONResponse;
import com.gravity4.facebook.dpareports.responseparser.resultdata.Actions.ActionTypesValueResultData;
import com.gravity4.facebook.dpareports.responseparser.resultdata.Actions.CampaignActionTypesResultData;
...
public class ActionTypeCampaignStats {

    Logger logger = LoggerFactory.getLogger(ActionTypeCampaignStats.class);

    @Autowired
    ActionTypeCampaignLevelStatsDAO actionTypeCampaignLevelStatsDAO;

    @Autowired
    OAuthExpirationTokenChecker oAuthExpirationTokenChecker;

    /*
       Makes a Get API call to report stats API to get the statistics at the Ad Group Level
        */
    public String getActionTypeCampaignstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
        ...
        String level="campaign_group";
        String date_preset = "yesterday";
        String action_breakdowns = "['action_type']";
        String fields = "['campaign_group_name','campaign_group_id','actions']";
         ...
         */
            if (status) {
                ...
                CampaignActionTypesStatsJSONResponse response = gson.fromJson(jsonfeed, CampaignActionTypesStatsJSONResponse.class);

                List<CampaignActionTypesResultData> results = response.data;
               ...
               ActionTypeStatsLoader adGroupStatsLoader;
                ...
                for (CampaignActionTypesResultData resultData : results) {
            ...
            are getting yesterday's date in date_preset field of the curl request*/
                        ...
                        adGroupStatsLoader.setID(Long.parseLong(resultData.campaign_group_id.trim()));
                        adGroupStatsLoader.setName(resultData.campaign_group_name);
                ...
                actionTypeCampaignLevelStatsDAO.storeactionscampaignlevelstats(adGroupStatsLoaderList);
                ...
                csvActionsCampaignStatsList=actionTypeCampaignLevelStatsDAO.fileactionsdcampaignlevelstats(Client_ID, emailstatsdate);
                //call the CSV file writer
                String stored= ActionsCampaignCSVWriter.writecsvfile(csvActionsCampaignStatsList, Client_ID, emailstatsdate, csv_address);
