...
import com.gravity4.facebook.dpareports.CSVFileWriter.Country.CountryAdSetCSVWriter;
import com.gravity4.facebook.dpareports.dao.Country.CountryAdSetLevelStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.Country.CountryAdSetStatsJSONResponse;
...
public class CountryAdSetStats {

    Logger logger = LoggerFactory.getLogger(CountryAdSetStats.class);


    @Autowired
    CountryAdSetLevelStatsDAO countryAdSetLevelStatsDAO;
    ...
    /*
        ...
        */
    public String getCountryAdSetstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
        ...
        String data_columns = "['campaign_name','spend','country','total_actions'," +
         ...
         */
            if (status) {
                ...
                CountryAdSetStatsJSONResponse response = gson.fromJson(jsonfeed, CountryAdSetStatsJSONResponse.class);

                List<CountryAdSetResultData> results = response.data;
                ...
                for (CountryAdSetResultData resultData : results) {
            ...
            are getting yesterday's datein date_preset field of the curl request*/
                    ...
                    adSetStatsLoader.setRegion("");

                    adSetStatsLoaderList.add(adSetStatsLoader);


                }
                countryAdSetLevelStatsDAO.storeadsetlevelstats(adSetStatsLoaderList);


                //for storing into file for email
                List<CSVCountryAllAdSetStats> csvCountryAllAdSetStatsList;
                java.sql.Date emailstatsdate = new java.sql.Date(StatisticsDate.getYesterday().getTime());
                csvCountryAllAdSetStatsList=countryAdSetLevelStatsDAO.fileadsetlevelstats(Client_ID,emailstatsdate);
                //call the CSV file writer
                String stored= CountryAdSetCSVWriter.writecsvfile(csvCountryAllAdSetStatsList, Client_ID, emailstatsdate,csv_address);
