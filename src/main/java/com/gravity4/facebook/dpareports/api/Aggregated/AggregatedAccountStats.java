...
import com.gravity4.facebook.dpareports.CSVFileWriter.Aggregated.AggregatedAccountCSVWriter;
import com.gravity4.facebook.dpareports.dao.AggregatedandAgeandGender.OverAllAccountLevelStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.Aggregated.AggregatedAccountStatsJSONResponse;
...
public class AggregatedAccountStats {

    Logger logger = LoggerFactory.getLogger(AggregatedAccountStats.class);

    @Autowired
    OverAllAccountLevelStatsDAO overAllAccountLevelStatsDAO;
    ...
    /*
        ...
        */
    public String getOverAllAccountstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
         ...
         */
            if (status) {
                ...
                AggregatedAccountStatsJSONResponse response = gson.fromJson(jsonfeed, AggregatedAccountStatsJSONResponse.class);

                List<AggregatedAccountsResultData> results = response.data;
                ...
                for (AggregatedAccountsResultData resultData : results) {
            ...
            are getting yesterday's datein date_preset field of the curl request*/
                ...
                overAllAccountLevelStatsDAO.storeaggregatedaccountlevelstats(accountStatsLoaderList);
                //for storing into file for email
                List<CSVAggregatedAccountStats> csvAggregatedAccountStatsList;
                java.sql.Date emailstatsdate = new java.sql.Date(StatisticsDate.getYesterday().getTime());
                csvAggregatedAccountStatsList=overAllAccountLevelStatsDAO.fileaggregatedaccountlevelstats(Client_ID,emailstatsdate);
                //call the CSV file writer
               String stored= AggregatedAccountCSVWriter.writecsvfile(csvAggregatedAccountStatsList, Client_ID, emailstatsdate,csv_address);
