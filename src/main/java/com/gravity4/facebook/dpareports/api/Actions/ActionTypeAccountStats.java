...
import com.gravity4.facebook.dpareports.CSVFileWriter.Actions.ActionsAccountCSVWriter;
import com.gravity4.facebook.dpareports.dao.Actions.ActionTypeAccountLevelStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.actions.AccountActionTypesStatsJSONResponse;
import com.gravity4.facebook.dpareports.responseparser.resultdata.Actions.AccountActionTypesResultData;
...
public class ActionTypeAccountStats {

    Logger logger = LoggerFactory.getLogger(ActionTypeAccountStats.class);

    @Autowired
    ActionTypeAccountLevelStatsDAO actionTypeAccountLevelStatsDAO;
    ...
    /*
        ...
        */
    public String getActionTypeAccountstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
        ...
        String fields = "['account_name','account_id','actions']";
         ...
         */
            if (status) {
                ...
                AccountActionTypesStatsJSONResponse response = gson.fromJson(jsonfeed, AccountActionTypesStatsJSONResponse.class);

                List<AccountActionTypesResultData> results = response.data;
               ...
               ActionTypeStatsLoader adGroupStatsLoader;
                ...
                for (AccountActionTypesResultData resultData : results) {
            ...
            are getting yesterday's date in date_preset field of the curl request*/
                        ...
                        adGroupStatsLoader.setID(Long.parseLong(resultData.account_id.trim()));
                        adGroupStatsLoader.setName(resultData.account_name);
                ...
                actionTypeAccountLevelStatsDAO.storeactionsaccountlevelstats(adGroupStatsLoaderList);
                ...
                csvActionsAccountStatsList=actionTypeAccountLevelStatsDAO.fileactionsdaccountlevelstats(Client_ID, emailstatsdate);
                //call the CSV file writer
                String stored= ActionsAccountCSVWriter.writecsvfile(csvActionsAccountStatsList, Client_ID, emailstatsdate, csv_address);
