package com.gravity4.facebook.dpareports.api.AgeandGender;
...
import com.gravity4.facebook.dpareports.CSVFileWriter.AgeandGender.OverAllAdSetCSVWriter;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.AgeandGender.OverAllAdSetStatsJSONResponse;
    ...
    public String getOverAllAdSetstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
         ...
         */
            ...
            are getting yesterday's datein date_preset field of the curl request*/
                ...
                List<CSVOverAllAdSetStats> csvOverAllAdSetStatsList;
                java.sql.Date emailstatsdate = new java.sql.Date(StatisticsDate.getYesterday().getTime());
                csvOverAllAdSetStatsList=overAllAdSetLevelStatsDAO.fileadsetlevelstats(Client_ID,emailstatsdate);
                //call the CSV file writer
                String stored= OverAllAdSetCSVWriter.writecsvfile(csvOverAllAdSetStatsList, Client_ID, emailstatsdate,csv_address);
