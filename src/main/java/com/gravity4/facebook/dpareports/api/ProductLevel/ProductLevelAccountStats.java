...
import com.gravity4.facebook.dpareports.CSVFileWriter.ProductLevel.ProductLevelAccountCSVWriter;
import com.gravity4.facebook.dpareports.dao.ProductLevel.ProductLevelAccountStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.ProductLevel.ProductLevelAccountStatsJSONResponse;
...
public class ProductLevelAccountStats {
    ...
    /*
        ...
        */
    public String getAccountstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
...
//for storing into file for email
                ...
                String stored= ProductLevelAccountCSVWriter.writecsvfile(csvProductLevelAccountStatsList, Client_ID, emailstatsdate,csv_address);
