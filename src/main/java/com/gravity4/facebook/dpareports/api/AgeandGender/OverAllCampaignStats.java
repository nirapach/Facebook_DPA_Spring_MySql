...
import com.gravity4.facebook.dpareports.CSVFileWriter.AgeandGender.OverAllCampaignCSVWriter;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.AgeandGender.OverAllCampaignStatsJSONResponse;
    ...
    public String getOverAllCampaignstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
         ...
         */
            ...
            are getting yesterday's datein date_preset field of the curl request*/
                ...
                String stored= OverAllCampaignCSVWriter.writecsvfile(csvOverAllCampaignStatsList, Client_ID, emailstatsdate,csv_address);
