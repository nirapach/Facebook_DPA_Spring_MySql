...
import com.gravity4.facebook.dpareports.CSVFileWriter.Actions.ActionsAdSetCSVWriter;
import com.gravity4.facebook.dpareports.dao.Actions.ActionTypeAdSetLevelStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.actions.AdSetActionTypesStatsJSONResponse;
import com.gravity4.facebook.dpareports.responseparser.resultdata.Actions.ActionTypesValueResultData;
import com.gravity4.facebook.dpareports.responseparser.resultdata.Actions.AdSetActionTypesResultData;
...
public class ActionTypeAdSetStats {

    Logger logger = LoggerFactory.getLogger(ActionTypeAdSetStats.class);

    @Autowired
    ActionTypeAdSetLevelStatsDAO actionTypeAdSetLevelStatsDAO;
    ...
    /*
        ...
        */
    public String getActionTypeAdSetstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
        ...
        String fields = "['campaign_name','campaign_id','actions']";
         ...
         */
            if (status) {
                ...
                AdSetActionTypesStatsJSONResponse response = gson.fromJson(jsonfeed, AdSetActionTypesStatsJSONResponse.class);

                List<AdSetActionTypesResultData> results = response.data;
               ...
               ActionTypeStatsLoader adGroupStatsLoader;
                ...
                for (AdSetActionTypesResultData resultData : results) {
            ...
            are getting yesterday's date in date_preset field of the curl request*/
                        ...
                        adGroupStatsLoader.setID(Long.parseLong(resultData.campaign_id.trim()));
                        adGroupStatsLoader.setName(resultData.campaign_name);
                ...
                actionTypeAdSetLevelStatsDAO.storeactionsadsetlevelstats(adGroupStatsLoaderList);
                ...
                csvActionsAdSetStatsList=actionTypeAdSetLevelStatsDAO.fileactionsdadsetlevelstats(Client_ID, emailstatsdate);
                //call the CSV file writer
                String stored= ActionsAdSetCSVWriter.writecsvfile(csvActionsAdSetStatsList, Client_ID, emailstatsdate, csv_address);
