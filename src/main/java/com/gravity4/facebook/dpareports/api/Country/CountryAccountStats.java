...
import com.gravity4.facebook.dpareports.CSVFileWriter.Country.CountryAccountCSVWriter;
import com.gravity4.facebook.dpareports.dao.Country.CountryAccountLevelStatsDAO;
...
import com.gravity4.facebook.dpareports.responseparser.responsedata.Country.CountryAccountStatsJSONResponse;
...
public class CountryAccountStats {

    Logger logger = LoggerFactory.getLogger(CountryAccountStats.class);

    @Autowired
    CountryAccountLevelStatsDAO countryAccountLevelStatsDAO;
    ...
    /*
        ...
        */
    public String getCountryAccountstats(long Account_ID_Integer, long Client_ID_Integer, String Access_Token,String csv_address) throws URISyntaxException, IOException, PropertyVetoException, SQLException, HTTPException {
        ...
        String data_columns = "['account_name','spend','country','total_actions'," +
         ...
         */
            if (status) {
                ...
                CountryAccountStatsJSONResponse response = gson.fromJson(jsonfeed, CountryAccountStatsJSONResponse.class);

                List<CountryAccountsResultData> results = response.data;
                ...
                for (CountryAccountsResultData resultData : results) {
            ...
            are getting yesterday's datein date_preset field of the curl request*/
                    ...
                    countryAndRegionAccountStatsLoader.setCountry(resultData.country);
                    ...
                    countryAndRegionAccountStatsLoader.setRegion("");
                ...
                countryAccountLevelStatsDAO.storeaccountlevelstats(countryAndRegionAccountStatsLoaderList);
                //for storing into file for email
                List<CSVCountryAllAccountStats> csvCountryAllAccountStatslist;
                java.sql.Date emailstatsdate = new java.sql.Date(StatisticsDate.getYesterday().getTime());
                csvCountryAllAccountStatslist=countryAccountLevelStatsDAO.fileaccountlevelstats(Client_ID,emailstatsdate);
                //call the CSV file writer
               String stored= CountryAccountCSVWriter.writecsvfile(csvCountryAllAccountStatslist,Client_ID,emailstatsdate,csv_address);
