...
import com.gravity4.facebook.dpareports.mapper.Country.CountryCampaignCSVMapper;
...
public class CountryCampaignLevelStatsDAO extends BaseDAO {

    public List<CSVCountryCampaignStats> fileadsetlevelstats(final long page_id,Date Stats_date) {

        List<CSVCountryCampaignStats> csvOverAllCampaignStatsList;
        String SELECT = " SELECT * "
                + " FROM CountryLevel_Campaign_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        csvOverAllCampaignStatsList=getJdbcTemplate().query(SELECT,new CountryCampaignCSVMapper());
    ...
    public void storecamapignlevelstats(final List<CountryandRegionCampaignStatsLoader> campaignStatsLoaderList) {
        ...
        String query = "INSERT INTO CountryLevel_Campaign_Statistics_Results" +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                ...
                statement.setString(4, campaignStatsLoader.getCountry());
