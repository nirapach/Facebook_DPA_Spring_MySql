...
import com.gravity4.facebook.dpareports.mapper.Country.CountryAccountCSVMapper;
...
public class CountryAccountLevelStatsDAO extends BaseDAO {

    public List<CSVCountryAllAccountStats> fileaccountlevelstats(final long page_id,Date Stats_date) {

        List<CSVCountryAllAccountStats> overAllAccountStatsList;
        String SELECT = " SELECT * "
                + " FROM CountryLevel_AdAccount_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        overAllAccountStatsList=getJdbcTemplate().query(SELECT,new CountryAccountCSVMapper());
    ...
    public void storeaccountlevelstats(final List<CountryAndRegionAccountStatsLoader> accountStatsLoaderList) {
        ...
        String query = "INSERT INTO CountryLevel_AdAccount_Statistics_Results" +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                ...
                statement.setString(4, accountStatsLoader.getCountry());
