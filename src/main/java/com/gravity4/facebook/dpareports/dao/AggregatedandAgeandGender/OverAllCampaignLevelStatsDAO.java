...
import com.gravity4.facebook.dpareports.mapper.Aggregated.AggregatedCampaignCSVMapper;
import com.gravity4.facebook.dpareports.mapper.AgeandGender.OverAllCampaignCSVMapper;
...
public class OverAllCampaignLevelStatsDAO extends BaseDAO {
    ...
    public List<CSVAggregatedCampaignStats> fileaggregatedadsetlevelstats(final long page_id,Date Stats_date) {

        List<CSVAggregatedCampaignStats> csvOverAllCampaignStatsList;
        String SELECT = " SELECT * "
                + " FROM Aggregated_Campaign_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        csvOverAllCampaignStatsList=getJdbcTemplate().query(SELECT,new AggregatedCampaignCSVMapper());
    ...
    public void storeaggregatedcamapignlevelstats(final List<CampaignStatsLoader> campaignStatsLoaderList) {

        String query = "INSERT INTO Aggregated_Campaign_Statistics_Results" +
                "(Application_Client_ID," +
                "Application_Campaign_ID," +
                "Application_Campaign_Name," +
                "Client_Reports_Reach," +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                ...
                statement.setLong(2, campaignStatsLoader.getCampaign_ID());
                statement.setString(3,campaignStatsLoader.getCampaign_Name());
                statement.setInt(4, campaignStatsLoader.getReach());
                statement.setDouble(5, campaignStatsLoader.getFrequency());
                statement.setInt(6, campaignStatsLoader.getImpressions());
                statement.setInt(7, campaignStatsLoader.getClicks());
                statement.setInt(8, campaignStatsLoader.getTotal_Actions());
                statement.setInt(9, campaignStatsLoader.getSocial_Reach());
                statement.setInt(10, campaignStatsLoader.getSocial_Impressions());
                statement.setInt(11, campaignStatsLoader.getUnique_Impressions());
                statement.setInt(12, campaignStatsLoader.getUnique_Social_Impressions());
                statement.setDouble(13, campaignStatsLoader.getCPM());
                ...
                statement.setDouble(21, campaignStatsLoader.getCost_Per_Unique_Click());
            }
