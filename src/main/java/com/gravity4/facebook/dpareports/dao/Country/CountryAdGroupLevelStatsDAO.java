...
import com.gravity4.facebook.dpareports.mapper.Country.CountryAdGroupCSVMapper;
...
public class CountryAdGroupLevelStatsDAO extends BaseDAO {

    public List<CSVCountryAdGroupStats> fileadgrouplevelstats(final long page_id,Date Stats_date) {

        List<CSVCountryAdGroupStats> csvOverAllAdGroupStatsList;
        String SELECT = " SELECT * "
                + " FROM CountryLevel_AdGroup_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        csvOverAllAdGroupStatsList=getJdbcTemplate().query(SELECT,new CountryAdGroupCSVMapper());
    ...
    public void storeadgrouplevelstats(final List<CountryAndRegionAdGroupStatsLoader> adGroupStatsLoaderList){
        ...
        String query = "INSERT INTO CountryLevel_AdGroup_Statistics_Results" +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                ...
                statement.setString(4, adGroupStatsLoader.getCountry());
