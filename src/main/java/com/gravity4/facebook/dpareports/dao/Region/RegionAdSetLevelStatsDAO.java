...
import com.gravity4.facebook.dpareports.mapper.Region.RegionAdSetCSVMapper;
...
public class RegionAdSetLevelStatsDAO extends BaseDAO {


    public List<CSVRegionAllAdSetStats> fileadsetlevelstats(final long page_id,Date Stats_date) {

        List<CSVRegionAllAdSetStats> CSVOverAllAdSetStats;
        String SELECT = " SELECT * "
                + " FROM RegionLevel_AdSet_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        CSVOverAllAdSetStats=getJdbcTemplate().query(SELECT,new RegionAdSetCSVMapper());
    ...
    public void storeadsetlevelstats(final List<CountryandRegionAdSetStatsLoader> adSetStatsLoaderList){
        ...
        String query = "INSERT INTO RegionLevel_AdSet_Statistics_Results" +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                ...
                statement.setString(4, adSetStatsLoader.getRegion());
