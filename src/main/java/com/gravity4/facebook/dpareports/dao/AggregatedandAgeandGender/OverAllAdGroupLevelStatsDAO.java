...
import com.gravity4.facebook.dpareports.mapper.Aggregated.AggregatedAdGroupCSVMapper;
import com.gravity4.facebook.dpareports.mapper.AgeandGender.OverAllAdGroupCSVMapper;
...
import com.gravity4.facebook.dpareports.model.CSVModels.AgeandGender.CSVOverAllAdGroupStats;
...
public class OverAllAdGroupLevelStatsDAO extends BaseDAO {
    ...
    public List<CSVAggregatedAdGroupStats> fileaggregatedadgrouplevelstats(final long page_id,Date Stats_date) {

        List<CSVAggregatedAdGroupStats> csvOverAllAdGroupStatsList;
        String SELECT = " SELECT * "
                + " FROM Aggregated_Ad_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        csvOverAllAdGroupStatsList=getJdbcTemplate().query(SELECT,new AggregatedAdGroupCSVMapper());
    ...
    public void storeaggregatedadgrouplevelstats(final List<AdGroupStatsLoader> adGroupStatsLoaderList){


        String query = "INSERT INTO Aggregated_Ad_Statistics_Results" +
                "(Application_Client_ID," +
                "Application_Ad_Group_ID," +
                "Application_Ad_Group_Name," +
                "Client_Reports_Reach," +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                ...
                statement.setInt(6, adGroupStatsLoader.getImpressions());
                statement.setInt(7, adGroupStatsLoader.getClicks());
                statement.setInt(8, adGroupStatsLoader.getTotal_Actions());
                statement.setInt(9, adGroupStatsLoader.getSocial_Reach());
                statement.setInt(10, adGroupStatsLoader.getSocial_Impressions());
                statement.setInt(11, adGroupStatsLoader.getUnique_Impressions());
                statement.setInt(12, adGroupStatsLoader.getUnique_Social_Impressions());
                statement.setDouble(13, adGroupStatsLoader.getCPM());
                statement.setDouble(14, adGroupStatsLoader.getCPP());
                statement.setDouble(15, adGroupStatsLoader.getCPC());
                statement.setDouble(16, adGroupStatsLoader.getCTR());
                statement.setDouble(17, adGroupStatsLoader.getSpend());
                statement.setDate(18, statsdate);
                statement.setDate(19, Activity_Start_Date);
                statement.setDate(20, Activity_End_Date);
                statement.setDouble(21, adGroupStatsLoader.getCost_Per_Unique_Click());
                statement.setDouble(22, adGroupStatsLoader.getRelevance_Score());
            }
