...
import com.gravity4.facebook.dpareports.mapper.Placement.PlacementAccountCSVMapper;
...
public class PlacementAccountLevelStatsDAO extends BaseDAO {

    public List<CSVPlacementAccountStats> fileaccountlevelstats(final long page_id,Date Stats_date) {

        List<CSVPlacementAccountStats> overAllAccountStatsList;
        String SELECT = " SELECT * "
                + " FROM PlacementLevel_AdAccount_Statistics_Results"
                + " WHERE Application_Client_ID="+page_id+" and Stats_Date="+"'"+Stats_date+"'";

        overAllAccountStatsList=getJdbcTemplate().query(SELECT,new PlacementAccountCSVMapper());

        return overAllAccountStatsList;
    }


    public void storeaccountlevelstats(final List<PlacementAccountStatsLoader> accountStatsLoaderList) {

        String query = "INSERT INTO PlacementLevel_AdAccount_Statistics_Results" +
        ...
        getJdbcTemplate().batchUpdate(query, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement statement, int i) throws SQLException {
                PlacementAccountStatsLoader accountStatsLoader = accountStatsLoaderList.get(i);
                ...
                statement.setString(4, accountStatsLoader.getPlacement());
                statement.setString(5, accountStatsLoader.getImpression_Device());
