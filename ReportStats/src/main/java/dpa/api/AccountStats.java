...
public class AccountStats {
    ...
    /*
        ...
        */
    public void getAccountstats(int Account_ID_Integer,int Client_ID_Integer,String Access_Token) throws URISyntaxException, IOException {
        
        //Fields in the parameters
        String Client_ID=Integer.toString(Client_ID_Integer);
